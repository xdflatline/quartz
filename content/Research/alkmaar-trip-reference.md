...
## 4. Dunes, Beach, and Walking Trips
...
### 4.1 Schoorlse Duinen (main entrance, west)
...
These are reachable as day trips from the stay and worth a slot if time allows. None is core to a Bergen / Schoorl week, but each is a short detour.

### 5.1 Alkmaar Cheese Market (Waagplein, Alkmaar)
