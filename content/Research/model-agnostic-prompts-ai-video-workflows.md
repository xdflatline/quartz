...
detail: "Methodology for designing AI video generation pipelines that survive model changes. The prompt is treated as compiled output, not source of truth: a stable intermediate representation (IR) describing each shot as structured fields is translated per-model by a thin adapter at render time."
