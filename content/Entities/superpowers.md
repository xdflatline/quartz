...
detail: "Claude Code skill package that enforces a six-step engineering workflow (brainstorm, spec, plan, task-by-task build, test) so the AI cannot jump to writing code without human-approved gates."
