---
title: "Best practices for prompt engineering for 2026 (Claude blog, 2025-11-10)"
details: "Raw extraction of Anthropic's 2026 prompt-engineering guide, covering the core techniques (be explicit, provide context, be specific, use examples, give permission to say I don't know), advanced techniques (prefilling, chain of thought, prompt chaining, format control), and the now-deprecated techniques (XML tags, heavy role prompting) that modern Claude handles without scaffolding."
tags: [raw, prompt-engineering, llm]
source: "https://claude.com/blog/best-practices-for-prompt-engineering"
authors: ["Anthropic Docs Team"]
venue: "Claude blog"
...
> Original source: [claude.com/blog/best-practices-for-prompt-engineering](https://claude.com/blog/best-practices-for-prompt-engineering)
> Published: November 10, 2025 — Category: Agents
> This is Anthropic's current "best practices for prompt engineering" guide. It supersedes earlier community prompt-engineering posts and reflects what works with Claude 4.x / Claude 5 generation models.
...
It's also the essential building block of [context engineering](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents), which has emerged as an increasingly important part of working with LLMs. Prompting is converging with [context engineering for Claude 5 generation models](https://claude.com/blog/the-new-rules-of-context-engineering-for-claude-5-generation-models) — less scaffolding, more curation.
...
**What makes a prompt specific enough?** Include:
...
**Basic chain of thought** — Simply add "Think step-by-step" to your instructions.
...
**Guided chain of thought** — Structure your prompt to provide specific reasoning stages.
...
**Structured chain of thought** — Use tags to separate reasoning from the final answer.
...
Remember to use prompt engineering techniques when they make sense and justify their usage. For comprehensive guidance on managing context effectively, check out Anthropic's blog post on [context engineering](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents).
