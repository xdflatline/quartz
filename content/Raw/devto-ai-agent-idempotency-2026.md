...
detail: Article arguing that most production AI agent failures are reliability failures (duplicate writes), not reasoning failures, and that idempotency borrowed from payments infrastructure is the fix.
