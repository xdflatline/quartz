...
updated: 2026-09-13
type: raw
source: https://bkent.net/Doc/darxrp.htm
---

# Data and Reality [Excerpts]

**Source:** bkent.net (https://bkent.net/Doc/darxrp.htm)
**Date Retrieved:** 2026-09-13
**Type:** Article (book excerpts, philosophical foundations of data modeling)
**Author:** William Kent
**Original Publication:** North Holland, 1978; republished by 1stBooks, 1998
...
> — William Kent, *Data and Reality*, Preface to the original edition
...
Tools tend to be incomplete in this respect. They incorporate those elements of a function which are useful and profitable; why bother with the rest? The justification for a tool is economic: the cost of its production and maintenance vs. the value of its problem solving functions. This has nothing to do with completeness.
...
The accidents of vocabulary: we are most prepared to identify as entities or relationships those things for which our vocabulary happens to contain a word. The presence of such word focusses our thinking onto what then appears as a singular phenomenon. The absence of such a word renders the thought diffuse, non-specific, non-singular.
...
## References cited in the excerpts

- [Hayakawa] — S. I. Hayakawa, *Language in Thought and Action* (origin of "the map is not the territory")
- [Zemanek 72] — Heinz Zemanek, *Philosophical Observations on the Real World and on the Computer*
- [Mealy] — G. H. Mealy, *Another Look at Data* (classic paper on the theory of data)
- [Thomas] — Lewis Thomas, on the human as a symbiotic colony
- [Jastrow] — Robert Jastrow, on the crossing of human and artificial intelligence (~year 2000)
- [Whorf] — Benjamin Lee Whorf, *Language, Thought, and Reality* / *Science and Linguistics* (Sapir-Whorf hypothesis)
- [Sagatsa] — quoted epigraph on the inevitability of losing one's way
- [G. Kent] — George Kent (William's brother, Political Science, University of Hawaii) — quoted epigraph

## Related Concepts (added by wiki editor)

- [[Concepts/map-vs-territory-data-modeling]] — "the map is not the territory" applied to data structures
- [[Concepts/three-worlds-ontology-amorphous]] — Kent's three-world framing and the amorphousness of information
- [[Concepts/data-model-as-tool-not-theory]] — models as tools vs. theories; users adapt to tools
- [[Concepts/reconciliation-by-scope-and-purpose]] — viewpoint reconciliation degrades with scope
- [[Concepts/linguistic-relativity-of-modeling]] — vocabulary shapes which entities we see as singular

## Related Entities

- [[Entities/william-kent]] — author
