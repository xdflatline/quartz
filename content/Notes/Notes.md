...
> [!tip] Base Views
> Switch between tabs to see different views of the same data:
> - **All Notes** — Sortable table with title, tags, description
> - **By Category** — Grouped by tags
> - **Compact List** — Minimal list view

---

[[index|← Back to Home]]

#tags/index #notes #navigation