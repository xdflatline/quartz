...
detail: "Reference set of benchmarks used to evaluate coding agents and AI research automation systems. Each is a useful signal for a different capability — paper reproduction, ML research engineering, Kaggle-style competitions, GPU kernel generation, computational reproducibility, and data-driven scientific discovery."
