...
detail: "Architectural pattern where the AI agent is the orchestrator and production decisions live in declarative instructions (YAML manifests + Markdown skills), not in imperative code. OpenMontage's defining pattern."
