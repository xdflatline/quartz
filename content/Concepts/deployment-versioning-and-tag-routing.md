...
detail: "Auto-versioned, immutable deployment snapshots; exclusive and shared tags route traffic without per-deployment tokens; invocations are serverless and start a fresh durable execution from the saved snapshot."
