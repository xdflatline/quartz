...
detail: "Architecture pattern where a deployment-ready runtime wraps an LLM with API server, auth, streaming, state, error handling, and tool integration so a raw model becomes a production service."
